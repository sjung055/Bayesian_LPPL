...
# B_{lp, c}: tight priors & calendar time model
...
N = dim(tight_priors.data)[1]

## taking log to the price to make q(t)
### q(t_{i+1})
q_ti1 = log(tight_priors.data[2:N, ]$"Close")
### q(t_i)
q_ti = log(tight_priors.data[1:(N-1), ]$"Close")

## calendar time model
### t_{i+1}
ti1 = tight_priors.data[2:N, ]$"Date"
### t_i
ti = tight_priors.data[1:(N-1), ]$"Date"

### t
tN = tight_priors.data[N, ]$"Date"
