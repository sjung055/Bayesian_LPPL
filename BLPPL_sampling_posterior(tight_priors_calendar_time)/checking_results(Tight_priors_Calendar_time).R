...
# B_{lp, m}: tight priors & calendar time model

title = "tight priors & calendar time"
...
hist(posterior_samples$tau, breaks = 50, freq = F,
     ...
     xlim = c(10000,20000))
abline(v = tau.paper, lty = lty_vec[1], lwd = 2, col = colors_vec[1])
...
hist(log(posterior_samples$B), breaks = 50, freq = F,
     ...
     xlim = c(-6,-2))
abline(v = log(B.paper), lty = lty_vec[1], lwd = 2, col = colors_vec[1])
abline(v = mean(log(posterior_samples$B)), lty = lty_vec[2],
       lwd = 2, col = colors_vec[2])
legend(-4, 4, col = colors_vec, border = "white", box.lty = 0,
       lty = lty_vec, lwd = 2, cex = 0.7,
       legend = c("posterior mean(paper)",
                  "posterior mean(this algorithm)"),
)
...
hist(posterior_samples$C, breaks = 50, freq = F,
     ...
     xlim = c(0,1))
abline(v = C.paper, lty = lty_vec[1], lwd = 2, col = colors_vec[1])
abline(v = mean(posterior_samples$C), lty = lty_vec[2],
       lwd = 2, col = colors_vec[2])
legend(0.05,3.5, col = colors_vec, border = "white", box.lty = 0,
       lty = lty_vec, lwd = 2, cex = 0.7,
       legend = c("posterior mean(paper)",
                  "posterior mean(this algorithm)"),
)
...
hist(posterior_samples$beta, breaks = 50, freq = F,
     ...
     xlim = c(0,1))
abline(v = beta.paper, lty = lty_vec[1], lwd = 2, col = colors_vec[1])
...
hist(posterior_samples$omega, breaks = 50, freq = F,
     ...
     xlim = c(0,20))
abline(v = omega.paper, lty = lty_vec[1], lwd = 2, col = colors_vec[1])
...
hist(posterior_samples$phi, breaks = 50, freq = F,
     ...
     xlim = c(0,2*pi))
abline(v = phi.paper, lty = lty_vec[1], lwd = 2, col = colors_vec[1])
abline(v = mean(posterior_samples$phi), lty = lty_vec[2],
       lwd = 2, col = colors_vec[2])
legend(0, 0.3, col = colors_vec, border = "white", box.lty = 0,
       lty = lty_vec, lwd = 2, cex = 0.7,
       legend = c("posterior mean(paper)",
                  "posterior mean(this algorithm)"),
)
...
hist(posterior_samples$tctN, breaks = 50, freq = F,
     ...
     xlim = c(0,8))
abline(v = tctN.paper, lty = lty_vec[1], lwd = 2, col = colors_vec[1])
